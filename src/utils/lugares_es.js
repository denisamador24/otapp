...
const lugaresEs = [
  ...
  },
  {
    ...
    services: [
      'Hospedaje. rango de precio: $75 - $85',
      'Restaurante',
      'Renta de Motos, cuadrisiclos y Carros',
    ],
    activities: [],
    know: '',
  },
  ...
  },
 {
  ...
  },
  {
    ...
    description: 'Es un hermoso lugar  rodeado de naturaleza,se encuentra alas orillas de la playa con una vista hacia tres isletas, se pueden realizar diversas actividades qué harán tu experiencia única.',
    address: 'Del quinto 90 metros al norte y 1 km al este.',
    phone: '88860734',
    email: '',
    images: [
      'juan1',
    ...
    services: [
      `Hotel: <br> hospedaje: $65 a $180`,
      `Restaurante: <br> platillos: $6 a &16`
    ],
    activities: []
  },
  {
    ...
    services: [
      `Habitaciones privadas $30 (cabañas)
      <br>
      - Aire acondicionado
      <br>
      - 2 desayuno que van incluidos en el precio.
      `
    ],
    activities: []
  },
  ...
  },
  {
    ...
    activities: [],
    know: 'Durante el gobierno de Somoza,este terreno era utilizado para cultivar cocos y aún  podemos encontrar un de estás  palmeras en Perú.'
  },
  {
    name: 'Playa Mango',
    ...
    activities: [],
    know: 'Los árboles de  mangos que se encuentran en esta playa tiene aproximadamente más de 10 años,según datos de los trabajadores.' 
  },
  {
    name: 'El Río Istian',
  ...
  },
  {
    ...
    services: [],
    activities: [],
    know: 'La punta de Jesús María puede llegar a medir más de 1km de largo  en época secas.'
  },
  {
    name: 'El Pital',
  ...
  {
    name: 'El ojo de agua',
    description: 'Un lugar donde puedes relajarte bajo la sombra  de un bosque tropical, con una piscina de aguas cristalinas y refrescantes de origen volcánico, además de poseer una gran belleza natural,cuenta con una gran atención hacia sus clientes',
    address: 'Del empalme el quino 1.7km carretera santo domingo (altagracia rivas Nicaragua)',
    phone: '58310130',
  ...
  },
  {
    ...
    services: [
      ...
      'Jardin y Terraz',
      'WiFi gratis',
      'Alquiles de Coches y Bicicletas'
    ],
    activities: [
      'Senderismo',
      'Pesca',
  ...
  },
  {
    ...
    services: [],
    activities: [],
    know: 'esta playa cuenta con una leyenda del "caballo de oro",que según  locales aparecía junto a un árbol de ceibo.'
  },
  {
  ...
  },
  {
    ...
    services: [],
    activities: [],
    know: 'El nombre náhuatl del madera es coatlán qué significa"lugar del sol"o "lugar donde vive el sol".'
  },
  {
